...
import com.iset.service.IProduitService;
@CrossOrigin(origins = "*", maxAge = 3600)
	...
	@ResponseBody
	//required=false,name=
	public ResponseEntity<Response> addProduitt(@RequestParam("produit") String produit) throws JsonMappingException, JsonProcessingException
	{ 
	...
	@ResponseBody
	//required=false,name=
	public ResponseEntity<Response> addProduit(@RequestBody Produit produit) throws JsonMappingException, JsonProcessingException
	{ 
	
		Produit pro = productRepository.save(produit);
		if(pro != null)
		{return new ResponseEntity<Response>(new Response (), HttpStatus.OK);}
		else
		{
